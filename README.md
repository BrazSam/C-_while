...
quer que eu adicione **aquelas ondas decorativas e um painel de GitHub stats** no topo (tipo “Meus commits, linguagens, streaks, etc.”) pra deixar igual aos perfis de portfólio?
```
